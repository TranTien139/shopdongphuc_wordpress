...
<header class="header1">
    ...
    <div class="container-menu-header">
        ...
        <div class="wrap_header">
            <!-- Logo -->
            <a href="/" class="logo">
                <img src="<?php  echo get_theme_file_uri(); ?>/assets/images/icons/logo.png" alt="IMG-LOGO">
            </a>
        ...
        <div class="btn-show-menu">
            ...
            <div class="header-icons-mobile">
                ...
                <div class="header-wrapicon2">
                    <img src="<?php  echo get_theme_file_uri(); ?>/assets/images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
                        ...
                        <ul class="header-cart-wrapitem">
                            <li class="header-cart-item">
                                <div class="header-cart-item-img">
                                    <img src="<?php  echo get_theme_file_uri(); ?>/assets/images/item-cart-01.jpg" alt="IMG">
                                </div>
                            ...
                            <li class="header-cart-item">
                                <div class="header-cart-item-img">
                                    <img src="<?php  echo get_theme_file_uri(); ?>/assets/images/item-cart-02.jpg" alt="IMG">
                                </div>
                            ...
                            <li class="header-cart-item">
                                <div class="header-cart-item-img">
                                    <img src="<?php  echo get_theme_file_uri(); ?>/assets/images/item-cart-03.jpg" alt="IMG">
                                </div>
